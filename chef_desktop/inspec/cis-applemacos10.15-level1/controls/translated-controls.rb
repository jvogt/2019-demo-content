...
control "xccdf_org.cisecurity.benchmarks_rule_1.1_Verify_all_Apple_provided_software_is_current" do
  ...
  describe command("softwareupdate -l") do
    ...
    its("stderr") { should match(/No\snew\ssoftware\savailable/) }
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_1.6_Enable_macOS_update_installs" do
  ...
  "
  impact 1.0
  describe plist('/Library/Preferences/com.apple.SoftwareUpdate.plist', xpath: 'name(/plist/dict/key[text()=\'AutomaticallyInstallMacOSUpdates\']/following-sibling::*[1])') do
    it { should exist }
    its("xpath_value") { should cmp "true" }
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_2.5.3_Enable_Firewall" do
  ...
  "
  impact 1.0
  describe file('/Users/jvogt/firewall') do
    it { should exist }
  end
end
